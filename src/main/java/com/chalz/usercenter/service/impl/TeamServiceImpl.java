...
import com.chalz.usercenter.exception.BusinessException;
import com.chalz.usercenter.model.domain.Team;
import com.chalz.usercenter.mapper.TeamMapper;
...
import com.chalz.usercenter.model.enums.TeamStatusEnum;
...
import com.chalz.usercenter.service.TeamService;
...
public class TeamServiceImpl extends ServiceImpl<TeamMapper, Team>
    ...
    public List<TeamUserVO> listTeams(TeamQuery teamQuery, boolean isAdmin) {
        ...
        // todo 关联查询已加入的队伍用户信息（可能很耗费性能，建议使用手写sql实现）
    }
    ...
    public boolean updateTeam(TeamUpdateRequest teamUpdateRequest, User loginUser) {
        ...
        // todo 如果用户传入新数据和老数据一致，可以不修改，降低数据库使用
    }
    ...
    public boolean joinTeam(TeamJoinRequest teamJoinRequest, User loginUser) {
        ...
        // 只有一个线程能获取到锁
        RLock lock = redissonClient.getLock("fanqiepian:join_team");
        try {
            // 抢到锁并执行
            while (true) {
